...
import (
	"archive/zip"
	"bytes"
	"cto-github.cisco.com/NFV-BU/go-msx-build/pkg/maven"
...
func webJarPathFilter(fn pathMapperFunc, fileNames types.StringSet) pathMapperFunc {
	return func(fileName string) *string {
...
func InstallSwaggerUi(args []string) error {
	...
	resourcesWanted := types.StringSet{
		"swagger-ui.css":                  {},
